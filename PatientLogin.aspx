<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientLogin.aspx.cs" Inherits="ITHospital.PatientLogin" %>
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="mb-30">
                                            ...
                                            <h6 class="text-center nonecase-font" style="color: white;">Laboratory  Management System (LMS)</h6>
                                            <h3 class="text-center mb-10" style="font-size: 20px; color: #f2e8e8; font-weight: 800; text-shadow: 1px 2px 0px #000, 1px 4px 0px rgba(0,0,0,0.15);">Patient Login</h3>
                                        </div>
                                        <div class="form-wrap">
                                            <div>
                                                ...
                                                <div class="form-group text-center">
                                                    ...
                                                    <input type="button" style="background-color:#040404"  id="btnfingureprintlogin" class="btn btn-success btn-rounded" value="Scan Fingure" style="display:none" />
