...
function BindCombo(ele, ControlName) {
    ...
    $.ajax({
        ...
        url: "SchoolQuestionuploadDetail.aspx/BindComboBox",
...
function SaveData(filename) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'SchoolQuestionuploadDetail.aspx/SaveData',
        data: JSON.stringify({ FileName: filename, tablename: "Sheet1$", SetID: $('#ddlpaperset').val() }),
        async: false,
...
function BindGrid() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "SchoolQuestionuploadDetail.aspx/GetQuestionDetail",
