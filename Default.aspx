<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ITHospital.Default" %>
            ...
            <div class="wrapper pa-0">
                <header class="sp-header">
                    <div class="sp-logo-wrap" style="text-align: center;">
                        <img class="brand-img" runat="server" id="logo" src="#" alt="NESTMEDLAB" style="height:220px" />
                    </div>
                                        ...
                                        <div class="col-sm-12 col-xs-12">
                                            ...
                                            <div class="form-wrap">
                                                <div class="form-group text-center">
                                                    <asp:Button ID="btnuserlogin" runat="server" Text="User Login" style="background-color:#040404" class="btn btn-success btn-rounded" OnClick="btnuserlogin_Click" />
                                                    <asp:Button ID="btnpatientlogin" runat="server" Text="Patient Login" style="background-color:#040404"  class="btn btn-danger btn-rounded" OnClick="btnpatientlogin_Click" />
                                                    <asp:Button ID="btnstudentlogin" runat="server" Text="Student Login" style="background-color:#040404;display:none"  class="btn btn-warning btn-rounded" OnClick="btnstudentlogin_Click" />
                                                </div>
                ...
                <footer class="footer container-fluid pl-30 pr-30" style="/* position: fixed; *//* bottom: 26px; */font-weight: 800;height: 40px;color: #f6faf2;margin-top: 0 !important;margin-bottom: 0 !important;text-align: center;font-size: 32px;margin-right: 0px !important;/* padding: 10px; */width: calc(100vw - 0px);box-shadow: 0 -2px 2px 0 rgb(173, 218, 240);z-index: 20;">
                    <div class="row">
                            <p style="line-height: 15px; font-size: large; color:#f2e8e8"><span id="linklabel" runat="server"></span></p>
                      </div>
                </footer>
                <!-- /Footer -->
            </div>
