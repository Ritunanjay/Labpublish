...
$(document).ready(function () {
    ...
    $(document).on('keydown', ".txtresult", function (e) {
        ...
        if (formulanew != '') {
            FillResult(currentIndex + 1, '');
            nexfield = currentIndex + 1;
    ...
    $(document).on("click", "#btnsaveresult", function () {
        ...
        if (confirm(" Do you want to Save this Test Result?") == true) {
            ...
            $.ajax({
                ...
                url: "PathologyResultGroupWise.aspx/SaveResult",
                data: JSON.stringify({ IsValid: chck, RStatus: $("#ddlresultstatus").val() }),
                dataType: "json",
                contentType: "application/json; charset=utf-8",
                async: false,
                success: function (response) {
                    if (response.d.MsgID != 0) {
                        ...
                        window.close('PathologyResultGroupWise.aspx');
                    }
...
function BindCombo(ele, ControlName, code) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/BindComboBox",
...
function getCommentDetail(testid) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/GetCommentDetail",
...
function GetInsertDetail(id) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/GetInsertDetail",
...
function SaveHelpDetail(index, help, helphtml) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/SaveHelpDetail",
...
function GetPatientDetail() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/GetPatientDetail",
        data: JSON.stringify({}),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        async: false,
...
function FillResult(index, result) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/FillResult",
        ...
        if (data.d.constructor == Array) {
            ...
            if (data.d.length > 0) {
                for (var i = 0; i < data.d.length; i++) {
                  ...
                  "<td class='center'>" + profilename + " " + data.d[i].TestName + " - " + data.d[i].ItemName + "</td><td><input type='hidden' class='lnkformula' value='" + formula + "' /><input type='text'  style='width:200px' value='" + data.d[i].DefaultResult + "' class='form-control txtresult' onfocus='select(this);'  /></td>" +
...
function GetStructure() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/GetStructure",
        data: JSON.stringify({}),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        async: false,
...
function BindGrid() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/GetWorkloadDetail",
        data: "{}",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: FillJsonXML,
...
function GetHelpDetailList(itemid) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/GetItemHelpDetail",
...
function DeleteResultDetail() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyResultGroupWise.aspx/DeleteResultDetail",
        data: JSON.stringify({}),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        async: false,
