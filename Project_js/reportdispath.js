...
function BindCombo(ele, ControlName, code) {
    ...
    $.ajax({
        ...
        url: "ReportDispath.aspx/BindComboBox",
...
function setreportingvalues(status) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ReportDispath.aspx/setreportingvalues',
...
function SMSSentSave() {
    ...
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ReportDispath.aspx/SMSSent',
...
function EmailSentSave() {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ReportDispath.aspx/EmailSent',
        data: JSON.stringify({ status: false }),
        async: false,
        success: function (response) {
            if (response.d == "") {
...
function ReportingReport(status, id) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ReportDispath.aspx/PathologyReportingStatus',
...
function PrintReport(id) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'ReportDispath.aspx/PrintPathologyBillByReport',
...
function BindGrid() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "ReportDispath.aspx/GetPathologyDetail",
    ...
    function FillJsonXML(data) {
        $("#gv").empty();
        if (data.d.length > 0) {
            $('#gv').append("<thead><tr><th style='width:15px' class='center'>Print</th><th>Centre</th><th>UHID</th><th>PatientName</th><th>Mobile</th><th>EmailID</th><th>BillNo</th><th>TestList</th><th>BookingDate</th><th>BloodGroup</th><th>DoctorName</th></tr></thead><tbody>");
            for (var i = 0; i < data.d.length; i++) {
                ...
                $("#gv").append("<tr style='color:green'><td>" + printdetail + " " +
                        " </td>" +
