    ...
    $("#txtautoinvestigation").autocomplete({
        source: function (request, response) {
            $.ajax({
                ...
                url: "InvestigationPackage.aspx/SearchInvestigation",
...
function DeleteProfileByID(id) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "InvestigationPackage.aspx/DeleteProfileByID",
...
function DeleteRow(RowIndex) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "InvestigationPackage.aspx/DeleteRow",
...
function GetProfileInvestigation(TestID) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "InvestigationPackage.aspx/GetProfileInvestigation",
...
function BindCombo(ele, ControlName, status) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "InvestigationPackage.aspx/BindComboBox",
...
function ItemClear() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "InvestigationPackage.aspx/ItemClear",
        data: JSON.stringify({}),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        async: false,
...
function Save() {
    ...
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'InvestigationPackage.aspx/Save',
...
function BindGrid(investigation) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "InvestigationPackage.aspx/GetInvestigationInfoDetail",
    ...
    function FillJsonXML(data) {
        ...
        if (data.d.length > 0) {
            $("#gvinvestigation").append("<thead><tr><th style='width:15px' class='center'>Action</th><th>Code</th><th>Package</th><th>Order</th><th>Show</th><th>For</th><th>Status</th>" +
                "</tr></thead><tbody>");
...
function GetInvestigationByID(id) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "InvestigationPackage.aspx/GetInvestigationByID",
        data: JSON.stringify({ ID: id }),
        dataType: "json",
        async: false,
        success: function (response) {
