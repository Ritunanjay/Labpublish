...
function BindCombo(ele, ControlName, code) {
    ...
    $.ajax({
        ...
        url: "DoctorFlatCut.aspx/BindComboBox",
...
function SaveDoctorCut() {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DoctorFlatCut.aspx/SaveDoctorCut",
...
function CalculateAmount() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DoctorFlatCut.aspx/CalculateAmount",
        ...
        success: function (response) {
            ...
            if (response.d.length > 0) {
                $('#gvpathology').append("<thead><tr><th style='width:15px' class='center'><input type='checkbox' class='lnkallcheckdoctor' /> Select</th><th>Centre</th><th>UHID</th><th>PatientName</th><th>Mobile</th><th>EmailID</th><th>BillNo</th><th>TestList</th><th>Booking_Date</th><th>Bill_Amount</th><th>Paid_Amount</th><th>Percentage</th><th>Amount</th></tr></thead><tbody>");
...
function BindGrid() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DoctorFlatCut.aspx/GetWorkloadDetail",
...
function savecutstatusDetail(status, index) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "DoctorFlatCut.aspx/savecutstatusDetail",
