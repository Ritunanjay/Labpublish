...
function ReportValidate(billid,groupid, status) {
    $.ajax({
        ...
        url: 'PathologyWorkloadByGroup.aspx/ReportValidate',
...
function PrintReport(id) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'PathologyWorkloadByGroup.aspx/PrintPathologyBillByReport',
...
function ShowStructure(billid,groupid) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyWorkloadByGroup.aspx/ShowDetail",
...
function BindGrid() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyWorkloadByGroup.aspx/GetWorkloadDetail",
        data: JSON.stringify({ FromDate: $('#txtfromdate').val(), ToDate: $('#txttodate').val(), PatientFilter: $('#txtpatientfilter').val() ,groupid:$('#ddlgroup').val()}),
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: FillJsonXML,
        error: function (jqXHR, status, errorThrown) {
...
function BindCombo(ele, ControlName, status) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyWorkloadByGroup.aspx/BindComboBox",
