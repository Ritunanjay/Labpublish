...
$(document).ready(function () {
    ...
    $(document).on('click', '#btnadd', function () {
     ...
     $(document).on('click', '.lnkselect', function () {
        ...
        if (samplecollect.toString() == 'true') {
            alertify.log('Sample Already Collect');
            return;
        }
...
function RejectSample(received) {
    ...
    $.ajax({
        ...
        url: "PathologySampleCollection.aspx/SaveSampleCollect",
...
function SaveSampleDetail(received) {
    if ($('#ddldoctor').val() == "0")
    {
        alertify.error('Please Select Reporting Doctor');
        return;
    }
    var obj = {};
    obj.Received = received;
...
function GetSampleDetail(id, billid, sampleid) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologySampleCollection.aspx/GetSampleDetail",
...
function BindCombo(ele, ControlName) {
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologySampleCollection.aspx/BindComboBox",
...
function BindGrid() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologySampleCollection.aspx/GetSampleReceivedDetail",
...
function BindSampleDetail(billid, sampleid) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologySampleCollection.aspx/BindSampleDetail",
...
function BarCode(number, type, sampleno, patientdetail, uhidinfo) {
    $.ajax({
        type: "POST",
        url: "PathologySampleCollection.aspx/Barcode",
