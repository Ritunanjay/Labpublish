...
function ReportValidate(billid, status) {
    $.ajax({
        ...
        url: 'PathologyWorkloadByPatient.aspx/ReportValidate',
...
function PrintReport(id) {
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'PathologyWorkloadByPatient.aspx/PrintPathologyBillByReport',
...
function ShowStructure(billid) {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyWorkloadByPatient.aspx/ShowDetail",
...
function BindGrid() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "PathologyWorkloadByPatient.aspx/GetWorkloadDetail",
