...
function PrintBill(id) {
    $.ajax({
        ...
        url: 'VoucherDetail.aspx/PrintVoucherDetail',
...
function BindGrid() {
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "VoucherDetail.aspx/GetVoucherDetail",
        data: "{}",
        dataType: "json",
        contentType: "application/json; charset=utf-8",
        success: FillJsonXML,
    ...
    function FillJsonXML(data) {
        ...
        if (data.d.length > 0) {
            ...
            $("#gvvoucher").append("<thead><tr><th>Voucher Receipt List</th></tr></thead>");
...
function SaveVoucher() {
    ...
    if ($('#ddlcentre').val() == null) {
        ...
        $('#ddlcentre').focus();
        return false;
    } if ($('#ddlrefcentre').val() == null) {
        alertify.error("You Don't Have Permission Any Centre ! Please Contact Admin.");
        $('#ddlrefcentre').focus();
        return false;
    } if ($('#ddlrefcentre').val() == "0" && $('#txtpatientname').val() != '') {
        alertify.log('Please Select Main Centre First!');
        $('#ddlrefcentre').focus();
        return false;
    }
    if (paid <= 0) {
    ...
    $.ajax({
        type: 'POST',
        contentType: "application/json; charset=utf-8",
        url: 'VoucherDetail.aspx/SaveVoucher',
...
function BindAllComboBox() {
    ...
    BindCombo($("#ddlrefcentre"), "ddlrefcentre", '1');
    ...
    $.ajax({
        type: "POST",
        contentType: "application/json; charset=utf-8",
        url: "VoucherDetail.aspx/BindComboBox",
