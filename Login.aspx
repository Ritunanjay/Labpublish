<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="ITHospital.Login" %>
...
<body>
    <form id="form1" runat="server">
        <div class="fullscreen-bg">
            <video loop muted autoplay poster="Admin/img/multicolor.jpg" class="fullscreen-bg__video">

                <source src="video/lab.mp4" type="video/mp4" />
            </video>
            <asp:HiddenField ID="hdfum" runat="server" ClientIDMode="Static" Value="0" />
                    <div class="wrapper pa-0">
            <header class="sp-header">
                <div class="sp-logo-wrap" style="text-align: center;">
                    <a href="Alogin.aspx">
                     <img class="brand-img" runat="server" id="logo" src="#" alt="NESTMEDLAB" style="height:120px" />
                    </a>
                </div>
            ...
            <div class="page-wrapper pa-0 ma-0 auth-page">
                                ...
                                <div class="row">
                                    <div class="col-sm-12 col-xs-12">
                                        <div class="mb-30">
                                            ...
                                            <h6 class="text-center nonecase-font" style="color: white;">Advanced Technology made Life easy</h6>
                                        </div>
                                        <div class="form-wrap">
                                            <div>
                                                ...
                                                <div class="form-group text-center">
                                                    <asp:Button ID="Btnlogin" style="background-color:#040404"  class="btn btn-success btn-rounded" runat="server" Text="Sign In" OnClick="Btnlogin_Click" />
                                                    <a href="Default.aspx" style="background-color:#040404"  class="btn  btn-warning btn-rounded">Switch User</a>
                                                    <input type="button" style="background-color:#040404"  id="btnfingureprintlogin" class="btn btn-success btn-rounded" value="Scan Finger" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <!-- Footer -->
                <!-- Footer -->
               <footer class="footer container-fluid pl-30 pr-30" style="font-weight: 800;height: 40px;color: #f6faf2;margin-top: 0 !important;margin-bottom: 0 !important;text-align: center;font-size: 32px;margin-right: 0px !important;/* padding: 10px; */width: calc(100vw - 0px);box-shadow: 0 -2px 2px 0 rgb(173, 218, 240);z-index: 20;">
                    <div class="row">
