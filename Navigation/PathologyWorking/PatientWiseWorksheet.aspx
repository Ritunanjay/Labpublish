<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PatientWiseWorksheet.aspx.cs" Inherits="LabMS.Navigation.PathologyWorking.PatientWiseWorksheet" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 <script src="<%= ResolveClientUrl("~/project_js/patientwiseworksheet.js") %>"></script>
</asp:Content>
