<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="WorkloadByPatientWise.aspx.cs" Inherits="LabMS.Navigation.PathologyWorking.WorkloadByPatientWise" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <script src="<%= ResolveClientUrl("~/project_js/workloadbypatientwise.js") %>"></script>
