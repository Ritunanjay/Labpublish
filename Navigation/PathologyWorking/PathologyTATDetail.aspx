<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PathologyTATDetail.aspx.cs" Inherits="LabMS.Navigation.PathologyWorking.PathologyTATDetail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 <script src="<%= ResolveClientUrl("~/project_js/pathologytatdetail.js") %>"></script>
</asp:Content>
