<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="CollectSample.aspx.cs" Inherits="LabMS.Navigation.PathologyWorking.CollectSample" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script src="<%= ResolveClientUrl("~/project_js/collectsample.js") %>"></script>
</asp:Content>
        ...
        <div class="col-md-12 fixtopsectionbuttom">
            <div class="row heading-bg col-md-12">
                <div id="EditHeadTitle" runat="server">
                    <div class="col-md-9">
                        <div class="formheadtitle">Labourtary Sample Collect Detail </div>
            ...
            <div id="collapse_2" class="panel-wrapper collapse in" aria-expanded="true" style="">
                ...
                <div class="col-md-12 fixbuttonsectionbuttom">
                    <div class="col-md-12 text-center">
                        <input type="button" id="btnadd" accesskey="S" class="btn btn-success btn-xs" value="Save Sample Collect" />
