<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PatientBookingModify.aspx.cs" Inherits="LabMS.Navigation.PathologyWorking.PatientBookingModify" %>

<%@ Register Src="~/CommonDetail/Payment.ascx" TagPrefix="uc1" TagName="Payment" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
      <script src="<%= ResolveClientUrl("~/project_js/patientbookingmodify.js") %>"></script> 
            ...
            <div id="collapse_2" class="panel-wrapper collapse in" aria-expanded="true" style="">
                        ...
                        <fieldset class="fieldSetBorder">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            ...
                                            <input id="txtextra" style="width: 50%;" class="form-control" value="0" placeholder="Extra (Rs.)" onfocus="allownumericwithoutdecimal(this);" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            ...
                                            <input id="txtdiscountper" class="form-control" value="0" placeholder="Percentage (%)" onfocus="allownumeric(this);" style="width: 33%;" />
                                            <input id="txtdiscount" class="form-control" value="0" placeholder="Discount (Rs.)" onfocus="allownumeric(this);" style="width: 34%;" />
                                        </div>
                            ...
                            <div class="col-md-2" style="display:none">
                             ...
                             <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label ">
                                       Updation Remark</label>
                                    <input id="txtupdateremark" class="form-control" value="Authority By Admin" placeholder="Remark" onfocus="titlecase(this);" />
                ...
                <div class="col-md-12 fixbuttonsectionbuttom">
                    <div class="col-md-12 text-center">
                        <input id="btnpayment" type="button" accesskey="P" class="btn btn-info btn-xs lnkpayment" value="Payment Here" style="display:none" />
