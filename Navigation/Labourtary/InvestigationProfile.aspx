<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="InvestigationProfile.aspx.cs" Inherits="ITHospital.Navigation.Labourtary.InvestigationProfile" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="<%= ResolveClientUrl("~/project_js/investigationprofiledetail.js") %>"></script>
</asp:Content>
        ...
        <div class="col-md-12 fixtopsectionbuttom">
            <div class="row heading-bg col-md-12">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Investigation Profile Information Detail</h5>
                </div>
                <!-- Breadcrumb -->
            </div>
        </div>
                ...
                <div class="panel-body">
                    <div class="col-md-6">
                        <fieldset class="fieldSetBorder">
                            <legend class="fieldSetLabel">Add New Investigation Profile</legend>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            ...
                                            <input id="txtinvestigationname" class="form-control" placeholder="Profile Name" onfocus="titlecase(this);" clientidmode="Static" style="width: 70%" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label class="control-label">
                                        Group<samp style="color: Red">*</samp></label>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <div class="input-group-btn">
                                            ...
                                            <input id="btnsaveitem" type="button" accesskey="A" class="form-control" value="Save Item" style="width: 20%; background-color: #336699; color: #fdf9f9;">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-md-12">
                        <fieldset class="fieldSetBorder">
                            <legend class="fieldSetLabel">Profile Detail Search</legend>
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="control-label">
                                        Profile Name Search
                                    <samp style="color: Red">*</samp></label>
                                    <input id="txttestname" class="form-control" placeholder="Profile Name" clientidmode="Static" />
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h5 class="modal-title" id="myLargeModalLabel">Profile Detail</h5>
                </div>
