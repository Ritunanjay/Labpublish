<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PayrollHead.aspx.cs" Inherits="LabMS.Navigation.Payroll.PayrollHead" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <script src="<%= ResolveClientUrl("~/project_js/payrollheaddetail.js") %>"></script>
</asp:Content>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12 fixtopsectionbuttom">
            <div class="row heading-bg col-md-12">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Payroll Head Information</h5>
            ...
            <div id="collapse_2" class="panel-wrapper collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Payroll Head Information</legend>

                        <div class="col-md-2">
                            <div class="form-group">
                                <label class="control-label">
                                   Payment Head<samp style="color: Red">*</samp></label>
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                <label class="control-label">
                                  Amount(Rs.)<samp style="color: Red">*</samp></label>
                                <input id="txtamount" class="form-control" maxlength="5" placeholder="Rs." onfocus="allownumeric(this);" clientidmode="Static" />
                        ...
                        <div class="col-md-1">
                            <div class="form-group">
                                ...
                                <input id="txtpercentage" class="form-control" maxlength="3" placeholder="%" onfocus="allownumeric(this);" clientidmode="Static" />
                    ...
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Payroll Head Information List</legend>
        ...
        <div class="col-md-12 fixbuttonsectionbuttom">
            <div class="col-md-12 text-center">
                ...
                <input type="button" id="btnadd" accesskey="A" class="btn btn-success btn-xs" value="Add Head" />
