<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="LabourtaryReceipt.aspx.cs" Inherits="LabMS.Navigation.Billing.LabourtaryReceipt" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="<%= ResolveClientUrl("~/project_js/labourtaryreceipt.js") %>"></script>
</asp:Content>
        ...
        <div class="col-md-12 fixtopsectionbuttom">
            <div class="row heading-bg col-md-12">
                <div id="EditHeadTitle" runat="server">
                    <div class="col-md-9">
                        <div class="formheadtitle">Booking Receipt Detail </div>

                        <asp:HiddenField ID="hdfadd" runat="server" ClientIDMode="Static" Value="0" />
                        <asp:HiddenField ID="hdfbillid" runat="server" ClientIDMode="Static" Value="0" />
                        <asp:HiddenField ID="hdfrecordid" runat="server" ClientIDMode="Static" Value="0" />
            ...
            <div id="collapse_2" class="panel-wrapper collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Add New Receipt Detail</legend>
                    ...
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Booking Receipt Detail List</legend>
                ...
                <div class="col-md-12 fixbuttonsectionbuttom">
                    <div class="col-md-12 text-center">
                        ...
                        <input type="button" id="btnadd" accesskey="A" class="btn btn-success btn-xs" value="Submit Receipt" />
    ...
    <div id="ModalReceipt" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                    <h5 class="modal-title">All Receipt Detail Here</h5>
                </div>
                <div class="modal-body">
                    <fieldset class="fieldSetBorder">
                        ...
                        <div class="col-md-12" style="overflow: scroll; height: auto; width: 100%">
                            <div class="form-group">
                                <table class="table table-responsive table-stripped table-bordered" id="gvreceipt">
                                </table>
                            </div>
                        </div>
                    </fieldset>
