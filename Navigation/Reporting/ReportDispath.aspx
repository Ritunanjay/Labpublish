<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="ReportDispath.aspx.cs" Inherits="LabMS.Navigation.Reporting.ReportDispath" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
 <script src="<%= ResolveClientUrl("~/project_js/reportdispath.js") %>"></script>
</asp:Content>
