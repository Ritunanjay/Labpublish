<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PatientOutputDisplay.aspx.cs" Inherits="LabMS.Navigation.Output.PatientOutputDisplay" %>
<!DOCTYPE html>
...
<body style="background-color: #fff; zoom: 100%;">
    <form id="form1" runat="server">
        <div class="wrapper error-page pa-0">
          <div class="row">
                <div class="col-md-12 col-xs-12">
                    <div class="x_panel" style="text-align: center">
                        <div id="dvReport" class="col-md-7" style="text-align: center; left: 350px; right: 350px;">
                            ...
                            <CR:CrystalReportViewer ID="CrystalReportViewer1" runat="server" BorderStyle="Outset" HasCrystalLogo="False"
                                ...
                                ToolPanelView="GroupTree" PrintMode="Pdf" HasPrintButton="true" HasExportButton="true" />
                        </div>
                    </div>
                </div>
            </div>
