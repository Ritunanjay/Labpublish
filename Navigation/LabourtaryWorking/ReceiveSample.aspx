<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="ReceiveSample.aspx.cs" Inherits="LabMS.Navigation.LabourtaryWorking.ReceiveSample" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="<%= ResolveClientUrl("~/project_js/ReceiveSamplebysample.js") %>"></script>
</asp:Content>
