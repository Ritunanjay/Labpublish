<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PathologyWorkload.aspx.cs" Inherits="ITHospital.Navigation.LabourtaryWorking.PathologyWorkload" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="<%= ResolveClientUrl("~/project_js/pathologyworkload.js") %>"></script>
</asp:Content>
            ...
            <div id="collapse_2" class="panel-wrapper collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                    ...
                    <fieldset class="fieldSetBorder">
                        ...
                        <div class="col-md-12" style="overflow: scroll; height: auto; width: 100%;overflow:scroll">
                            <div class="form-group">
