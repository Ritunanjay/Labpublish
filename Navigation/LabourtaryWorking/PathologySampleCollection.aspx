<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PathologySampleCollection.aspx.cs" Inherits="LabMS.Navigation.LabourtaryWorking.PathologySampleCollection" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script src="<%= ResolveClientUrl("~/project_js/pathologysamplecollection.js") %>"></script>
</asp:Content>
