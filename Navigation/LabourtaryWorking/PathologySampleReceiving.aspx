<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PathologySampleReceiving.aspx.cs" Inherits="LabMS.Navigation.LabourtaryWorking.PathologySampleReceiving" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
<script src="<%= ResolveClientUrl("~/project_js/pathologysamplereceiving.js") %>"></script>
</asp:Content>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                     <fieldset class="fieldSetBorder" id="Fieldset1">
