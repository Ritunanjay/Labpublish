<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PathologyWorkloadByGroup.aspx.cs" Inherits="LabMS.Navigation.LabourtaryWorking.PathologyWorkloadByGroup" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <script src="<%= ResolveClientUrl("~/project_js/pathologyworkloadbygroup.js") %>"></script>
</asp:Content>
