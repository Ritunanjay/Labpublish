<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="PathologyWorkloadByPatient.aspx.cs" Inherits="LabMS.Navigation.LabourtaryWorking.PathologyWorkloadByPatient" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <script src="<%= ResolveClientUrl("~/project_js/pathologyworkloadbypatient.js") %>"></script>
</asp:Content>
