<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="AreaInfoDetail.aspx.cs" Inherits="ITHospital.Navigation.SoftwareInfo.AreaInfoDetail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="<%= ResolveClientUrl("~/project_js/areadetail.js") %>"></script>
</asp:Content>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12 fixtopsectionbuttom">
            <div class="row heading-bg col-md-12">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Area Infomration Detail</h5>
            ...
            <div id="collapse_2" class="panel-wrapper collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Add New Area</legend>

                        <div class="col-md-3">
                            <div class="form-group">
                                <label class="control-label mb-10">
                                    City Name<samp style="color: Red">*</samp></label>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label class="control-label mb-10">
                                    Area Name<samp style="color: Red">*</samp></label>
                                <input id="txtarea" class="form-control" placeholder="Area" onfocus="uppercase(this)" clientidmode="Static" />
                    ...
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Area List</legend>
        ...
        <div class="col-md-12 fixbuttonsectionbuttom">
            <div class="col-md-12 text-center">
                ...
                <input type="button" id="btnadd" class="btn btn-success btn-xs" value="Add Area" accesskey="A" />
