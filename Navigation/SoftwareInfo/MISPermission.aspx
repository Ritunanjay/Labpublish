<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="MISPermission.aspx.cs" Inherits="LabMS.Navigation.SoftwareInfo.MISPermission" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server"> 
    <script src="<%= ResolveClientUrl("~/project_js/mispermission.js") %>"></script>
</asp:Content>
        ...
        <div class="panel panel-default card-view panel-refresh" style="margin-top: 3%;">
            ...
            <div id="collapse_1" class="panel-wrapper collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                    ...
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Software MIS Perission List</legend>
