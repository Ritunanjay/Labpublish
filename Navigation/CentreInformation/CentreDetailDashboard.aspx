<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="CentreDetailDashboard.aspx.cs" Inherits="LabMS.Navigation.CentreInformation.CentreDetailDashboard" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    
    <script src="<%= ResolveClientUrl("~/project_js/centredetaildashboard.js") %>"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
       ...
       <script src="<%= ResolveClientUrl("~/Admin/JSData/dashboard_data.js") %>"></script>
