<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="DigitalCardDetail.aspx.cs" Inherits="LabMS.Navigation.DigitalCard.DigitalCardDetail" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    ...
    <script src="<%= ResolveClientUrl("~/project_js/digitalcarddetail.js") %>"></script>
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <div class="col-md-12 fixbuttonsectionbuttom">
        <div class="col-md-12 text-center">
            ...
            <input type="button" id="btnadd" accesskey="A" class="btn btn-success btn-xs" value="Save Digital Payment" />
