<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="SchoolClassSectionDetail.aspx.cs" Inherits="LabMS.Navigation.SchoolMaster.SchoolClassSectionDetail" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="<%= ResolveClientUrl("~/school_js/schoolclasssectioninfo.js") %>"></script>
</asp:Content>
        ...
        <div class="col-md-12 fixtopsectionbuttom">
            <div class="row heading-bg col-md-12">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    ...
                    <asp:HiddenField ID="hdfsectionid" runat="server" ClientIDMode="static" Value="0" />
            ...
            <div id="collapse_2" class="panel-wrapper collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Add New Class Section</legend>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
                                    <div class="input-group-btn">
                                        <select id="ddlclass" class="form-control" style="width:80%"></select>
  <a class="btn btn-warning btn-xs lnkclassrefresh" style="width:20%"><i class="fa fa-refresh"></i></a>
                                                                          </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-5">
                            <div class="form-group">
                                ...
                                <input id="txtsection" class="form-control" placeholder="Class Section" clientidmode="Static" />
