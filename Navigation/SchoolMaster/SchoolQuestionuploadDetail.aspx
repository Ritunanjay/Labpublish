<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="SchoolQuestionuploadDetail.aspx.cs" Inherits="LabMS.Navigation.SchoolMaster.SchoolQuestionuploadDetail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">

    <script src="<%= ResolveClientUrl("~/school_js/questionpaperupload.js") %>"></script>
</asp:Content>
    ...
    <div class="container-fluid">
        ...
        <div class="col-md-12 fixtopsectionbuttom">
            <div class="row heading-bg col-md-12">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Question Paper Upload</h5>
            ...
            <div id="collapse_2" class="panel-wrapper collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Upload Question Paper</legend>

                        <div class="col-md-4">
                            <div class="form-group">
                                <label class="control-label">
                                    PaperSet<samp style="color: Red">*</samp></label>
                    ...
                    <fieldset class="fieldSetBorder">
                        <legend class="fieldSetLabel">Paper Set Wise Question Detail List</legend>
        ...
        <div class="col-md-12 fixbuttonsectionbuttom">
            <div class="col-md-12 text-center">
                ...
                <input type="button" id="btnadd" accesskey="A" class="btn btn-success btn-xs" value="Add Question Paper" />
