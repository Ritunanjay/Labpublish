<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="MachineOrderDetail.aspx.cs" Inherits="ITHospital.Navigation.Machine.MachineOrderDetail" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="<%= ResolveClientUrl("~/project_js/machineorderdetail.js") %>"></script>
</asp:Content>
        ...
        <div class="col-md-12 fixtopsectionbuttom">
            <div class="row heading-bg col-md-12">
                <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                    <h5 class="txt-dark">Machine Order Detail</h5>
                </div>
                <!-- Breadcrumb -->
            </div>
        </div>
            ...
            <div id="collapse_1" class="panel-wrapper collapse in" aria-expanded="true" style="">
                <div class="panel-body">
                     <fieldset class="fieldSetBorder">
                        ...
                        <legend class="fieldSetLabel">Machine Order</legend>
