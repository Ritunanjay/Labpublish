<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/MainMaster.Master" AutoEventWireup="true" CodeBehind="DoctorMulticut.aspx.cs" Inherits="LabMS.Navigation.DoctorInformation.DoctorMulticut" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
  <script src="<%= ResolveClientUrl("~/project_js/doctormulticut.js") %>"></script>
</asp:Content>
