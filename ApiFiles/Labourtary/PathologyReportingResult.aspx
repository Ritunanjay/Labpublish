<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PathologyReportingResult.aspx.cs" Inherits="LabMS.ApiFiles.Labourtary.PathologyReportingResult" %>
...
<head id="Head1" runat="server">
    ...
    <script src="<%= ResolveClientUrl("~/project_js/pathologyreportingresultapi.js") %>"></script>
</head>
        ...
        <div class="wrapper error-page pa-0">
            <fieldset class="fieldSetBorder">
                ...
                <div class="col-md-12 text-left">
                    ...
                    <input type="button" id="btnvalidsaveresult" accesskey="V" class="btn btn-warning btn-xs" value="Validate & Save Result" />
                ...
                <fieldset class="fieldSetBorder">
                    ...
                    <div class="col-md-2">
                        <div class="form-group">
                            ...
                            <input id="txtbillno" class="form-control" placeholder="TestName" disabled="disabled" value="" clientidmode="Static" />
