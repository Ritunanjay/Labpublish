<%@ Page Title="" Language="C#" MasterPageFile="~/Masterpage/PatientMainMaster.Master" AutoEventWireup="true" CodeBehind="PatientWorkload.aspx.cs" Inherits="LabMS.PatientNavigation.PatientWorkload" %>

<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script src="<%= ResolveClientUrl("~/project_js/patientworkload.js") %>"></script>
</asp:Content>
